...
/* package qsort-0.1.0.0 */
#ifndef VERSION_qsort
#define VERSION_qsort "0.1.0.0"
#endif /* VERSION_qsort */
#ifndef MIN_VERSION_qsort
#define MIN_VERSION_qsort(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_qsort */
...
#define CURRENT_COMPONENT_ID "qsort-0.1.0.0-inplace-qsort"
