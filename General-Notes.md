...
In this instance it is implemented 'on-chain' and it should be noted that nobody is expected to write Plutus-core. As System F Omega with Recursive Data Types.
